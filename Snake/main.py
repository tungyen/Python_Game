...
from snakeClass.wall import Wall
from snakeClass.food import Food
from snakeClass.scoreBoard import Scoreboard
...
# 遊戲難度
level = turtle.textinput(title="貪食蛇-遊戲難度", prompt="請選擇遊戲難度：1(簡單) ~ 9(困難)")
